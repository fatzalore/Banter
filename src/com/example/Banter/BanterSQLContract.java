...
public class BanterSQLContract {
    ...
    static final String TAG_ROOM_ID = "room_id";
     static final String TAG_POST_ID = "post_id";
     static final String TAG_NAME = "name";
     static final String TAG_PASSWORD = "password";
     static final String TAG_ADMINPASSWORD = "admin_password";
     static final String TAG_DATE_CREATED = "date_created";
     static final String TAG_LAST_UPDATED = "last_updated";
     static final String TAG_POSTS = "posts";
